...
# load the data
dataset = load_dataset("json", data_files="20mingerman_simplification.jsonl")
print(dataset)
...
lora_config = LoraConfig(
    ...
    lora_alpha=16,  # The influence degree of training 
...
class CustomTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        #if matched_spans > 0:
        #    difficulty_loss = torch.log(difficulty_loss / matched_spans + 1.0)
